...
% 保存 ctexbook 原始的 chapter 换页逻辑
\let\thu@orig@chapter@break\CTEX@chapter@break

% 正文 chapter 不强制换页
\renewcommand\CTEX@chapter@break{}

% 一进入附录，就恢复原来的换页逻辑
\pretocmd{\appendix}{%
  \let\CTEX@chapter@break\thu@orig@chapter@break
}{}{}

\makeatother

% 五一数学建模竞赛 2026 论文格式规范覆盖
\makeatletter
\geometry{
  a4paper,
  margin = 3cm,
...
\ctexset{
  chapter = {
    format     = \centering\heiti\sihao[1]\bfseries,
    name       = {},
  ...
  section = {
    format     = \heiti\xiaosi[1]\bfseries,
    aftername  = \quad,
    beforeskip = 12bp,
    afterskip  = 6bp,
  },
...
% 定义Python代码高亮颜色
\definecolor{pyComment}{rgb}{0.4,0.4,0.4}
...
\graphicspath{{figures/}{code/outputs/figures/}{code/outputs/award/}}
\setlength{\textfloatsep}{8bp plus 2bp minus 2bp}
\setlength{\intextsep}{6bp plus 2bp minus 2bp}
